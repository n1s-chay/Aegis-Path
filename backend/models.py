# models_news.py (add to your models package)
from datetime import datetime
# Remove broken import and use correct db import if needed
# from models.models_news import db
from app.models import db  # or from backend.extensions import db
